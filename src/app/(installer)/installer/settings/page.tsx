...
export default function InstallerSettingsPage() {
  ...
  const displayName = profile.trade_name || profile.company_name || profile.full_name || "Mi empresa";
  ...
  return (
    <div className="max-w-2xl">
      <div className="mb-7">
        <h2 className="text-2xl font-bold text-[#1A2A3A]">Perfil y marca</h2>
        <p className="text-slate-500 text-sm mt-1">
          Tu nombre y logo aparecerán en las propuestas generadas para clientes.
        </p>
      </div>
      ...
      <form onSubmit={handleSave} className="space-y-5">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <p className="text-xs text-slate-400 mb-4">
            Esta información aparece en la firma de las propuestas enviadas a clientes.
          </p>
          <div className="space-y-4">
            <div>
              ...
              <input
                {...inp("company_name")}
                placeholder="Instalaciones García S.A.S"
                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFC107]"
              />
            </div>
            <div>
              ...
              <input
                {...inp("trade_name")}
                placeholder="García Solar · El nombre que ven tus clientes"
                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#FFC107]"
              />
            </div>
            <div>
          ...
          <div className="bg-[#1A2A3A] rounded-xl px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs mt-0.5">
                  {profile.company_name && profile.trade_name !== profile.company_name
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-right">
                <p className="text-white font-semibold text-sm">{profile.full_name || "Tu nombre"}</p>
                <p className="text-slate-400 text-xs mt-0.5">Instalador certificado</p>
                {profile.phone && (
                  <p className="text-slate-300 text-xs mt-1">{profile.phone}</p>
                )}
              </div>
            </div>
          </div>
