  ...
  const fetchStations = useCallback(async () => {
    ...
    for (const s of res.stationList) {
      ...
      stationLives.push({
        id: s.id,
        name: s.name,
        generationPower: (live.generationPower || 0) / 1000,
        consumptionPower: (live.consumptionPower || 0) / 1000,
        gridPower: (live.gridPower || 0) / 1000,
        purchasePower: (live.purchasePower || 0) / 1000,
        wirePower: (live.wirePower || 0) / 1000,
        batteryPower: (live.batteryPower || 0) / 1000,
        batterySOC: live.batterySOC || 0,
        chargePower: (live.chargePower || 0) / 1000,
        dischargePower: (live.dischargePower || 0) / 1000,
